                ...
                <div className={cn(
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className="pl-11 pr-11 h-12 rounded-xl bg-secondary/30 border-border/50 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all duration-300"
                      disabled={isLoading}
                    />
                    <button
                      type="button"

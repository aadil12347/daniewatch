...
export function EditLinksModeIndicator() {
  ...
  return (
    <div className="fixed right-6 bottom-6 z-50">
      <div className="rounded-full border border-border bg-background/95 backdrop-blur px-4 py-3 shadow-lg">
        <div className="flex items-center gap-3">
          <div className="min-w-0">
            <div className="text-xs font-semibold tracking-wide uppercase">Edit Links</div>
